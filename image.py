...
class ImageCaptcha(_Captcha):
    ...
    def __init__(self, width=180, height=60, fonts=None, font_sizes=None):
        ...
        self._height = height
        self._fonts = fonts or DEFAULT_FONTS
        self._font_sizes = font_sizes or (58,58,58)
        self._truefonts = []
    ...
    def create_captcha_image(self, chars, color, background):
        ...
        '''
        def rndColor():
            return (random.randint(0, 80), random.randint(70, 150), random.randint(150, 255))
        base = random.randint(150,210)
        def rndColor1():
            return (random.randint(192-20,192+20), random.randint(192-20,192+20), random.randint(192-20,192+20))
        draw = Draw(image)
        for x in range(self._width):
            for y in range(self._height):
                if (x<3 or x>177 or y<4 or y>56):
        ...
        def _draw_character(c):
            ...
            # warp
            dx = w * random.uniform(0.10, 0.11)
            dy = h * random.uniform(0.20, 0.21)
        ...
        for im in images:
            ...
            offset = offset + w + random.randint(-rand/2,0)
    ...
    def generate_image(self, chars):
        ...
        """
        background = (0 , 0 , 250)
        color = random_color(220, 250, random.randint(220, 255))
